...
bartolini2015b = DB(Work(
    ...
    due="This work represents the first effort to represent the concepts of the GDPR as an ontology. However, such an approach has no direct relation to provenance. Additionally, the proposed ontology is not publicly available.",
    display="bartolini",
